...
create table user(
u_id varchar(8) primary key AUTO_INCREMENT,
id varchar(50) NOT NULL,
name varchar(50) NOT NULL,
phone varchar(11) NOT NULL,
regi_date varchar(8) NOT NULL,
...
APPROVAL_NUM varchar(8) NOT NULL, 
APPROVAL_DATE varchar(8) NOT NULL, 
APPROVAL_TIME varchar(8) NOT NULL, 
